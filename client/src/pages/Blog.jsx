  ...
  return data ? (
    <div className="relative">
      ...
      <div className="text-center mt-20 text-gray-600">
        ...
        <h1
          className="text-xl sm:text-5xl font-semibold max-w-2xl mx-auto
      text-gray-800"
        >
          {data.title}
        </h1>
          ...
          <div className="mt-14 mb-10 max-w-3xl mx-auto ">
            ...
            <div className="flex flex-col gap-4">
              {comment.map((item, index) => (
                <div
                  key={index}
                  className="relative bg-primary/2 border border-primary
    max-w-xl p-4 rounded text-gray-600"
      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-primary text-white rounded-2 px-8 hover:scale-102
